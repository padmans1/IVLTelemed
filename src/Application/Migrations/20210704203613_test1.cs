        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pincode = table.Column<double>(type: "double", nullable: false),
                    Email = table.Column<string>(type: "text", nullable: true),
                    MobExt = table.Column<string>(type: "text", nullable: true),
                    Mobile = table.Column<double>(type: "double", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaskSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageSide = table.Column<int>(type: "int", nullable: false),
                    ImageURL = table.Column<string>(type: "text", nullable: true),
                    MaskSettingsId = table.Column<int>(type: "int", nullable: true),
                    CameraSettings = table.Column<string>(type: "text", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImageInfo_MaskSettings_MaskSettingsId",
                        column: x => x.MaskSettingsId,
                        principalTable: "MaskSettings",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    FromUserId = table.Column<string>(type: "varchar(767)", nullable: true),
                    ToUserId = table.Column<string>(type: "varchar(767)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: true),
                    RightEyeObservations = table.Column<string>(type: "text", nullable: true),
                    LeftEyeObservations = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_AddressInfo_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_ImageInfo_ImageInfoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Images_Reports_ReportId1",
                        column: x => x.ReportId1,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Images_users_PatientId",
                        column: x => x.PatientId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageInfo_MaskSettingsId",
                table: "ImageInfo",
                column: "MaskSettingsId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_ImageInfoId",
                table: "Images",
                column: "ImageInfoId");
